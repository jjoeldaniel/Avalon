...
import periodicallyprogramming.avalon.commands.music.Play;
import periodicallyprogramming.avalon.commands.music.Playing;
import periodicallyprogramming.avalon.commands.music.Skip;
...
public class TrackScheduler extends AudioEventAdapter {
    ...
    public void onTrackEnd(AudioPlayer player, AudioTrack track, AudioTrackEndReason endReason) {
        ...
        if (endReason.mayStartNext) {
            ...
            if ( periodicallyprogramming.avalon.lavaplayer.AudioEventAdapter.isLooping()) {
                AudioTrack loop = track.makeClone();
                this.player.startTrack(loop, false);
            }

            else if ( periodicallyprogramming.avalon.lavaplayer.AudioEventAdapter.isShuffling()) {
