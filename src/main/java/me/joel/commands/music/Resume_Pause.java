...
public class Resume_Pause extends ListenerAdapter {
        ...
        switch (invoke) {
            ...
            case ("resume") -> {
                ...
                if (!Objects.requireNonNull(Objects.requireNonNull(event.getMember()).getVoiceState()).inAudioChannel()) {
                    event.replyEmbeds(Embed.VCRequirement.build()).setEphemeral(true).queue();
                    return;
                }
                ...
                if (Objects.requireNonNull(bot.getVoiceState()).inAudioChannel()) {
                    ...
                    if (!(botVC == memberVC)) {
                        event.replyEmbeds(Embed.sameVCRequirement.build()).setEphemeral(true).queue();
                        return;
                    }
                }
